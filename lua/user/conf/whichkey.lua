...
local mappings = {
  ...
  q = { '<cmd>lua require("user.conf.functions").smart_quit()<CR>', "Quit" },
  ...
  o = {
    ...
    w = { '<cmd>lua require("user.conf.functions").toggle_option("wrap")<cr>', "Wrap" },
    r = { '<cmd>lua require("user.conf.functions").toggle_option("relativenumber")<cr>', "Relative" },
    l = { '<cmd>lua require("user.conf.functions").toggle_option("cursorline")<cr>', "Cursorline" },
    s = { '<cmd>lua require("user.conf.functions").toggle_option("spell")<cr>', "Spell" },
    t = { '<cmd>lua require("user.conf.functions").toggle_tabline()<cr>', "Tabline" },
  ...
  R = {
    name = "Rust",
    a = { "<cmd>RustSetInlayHints<cr>", "a" },
    b = { "<cmd>RustDisableInlayHints<cr>", "b" },
    c = { "<cmd>RustToggleInlayHints<cr>", "c" },
    d = { "<cmd>RustRunnables<cr>", "d" },
    f = { "<cmd>RustExpandMacro<cr>", "f" },
    g = { "<cmd>RustOpenCargo<cr>", "g" },
    h = { "<cmd>RustParentModule<cr>", "h" },
    i = { "<cmd>RustJoinLines<cr>", "i" },
    s = { "<cmd>RustHoverActions<cr>", "s" },
    j = { "<cmd>RustHoverRange<cr>", "j" },
    k = { "<cmd>RustMoveItemDown<cr>", "k" },
    l = { "<cmd>RustMoveItemUp<cr>", "l" },
    m = { "<cmd>RustStartStandaloneServerForBuffer<cr>", "m" },
    n = { "<cmd>RustDebuggables<cr>", "n" },
    o = { "<cmd>RustViewCrateGraph<cr>", "o" },
    p = { "<cmd>RustSSR<cr>", "p" },
    q = { "<cmd>RustOpenExternalDocs<cr>", "q" },
  },
  ...
  l = {
    ...
    t = { '<cmd>lua require("user.conf.functions").toggle_diagnostics()<cr>', "Toggle Diagnostics" },
